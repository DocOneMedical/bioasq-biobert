"""
Utility functions for iterating through data.
"""
import collections
import json
import math
...
from bioasq_biobert import tokenization, modeling, optimization
from bioasq_biobert.run_list import FLAGS


class DoconeQuestionIterator:

    def __init__(self, docone_data_path: str):
        """
        Iterate through JSON produced by NILE.
        """
